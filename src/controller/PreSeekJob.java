...
/**
 * Servlet implementation class PreSeekJob
 */
@WebServlet("/PreSeekJob")
public class PreSeekJob extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("IndexPre.jsp").forward(request,response);
	}
